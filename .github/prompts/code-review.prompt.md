...
**Architecture (Pinia direct-use — ADR 014 as amended) — high priority**
...
**Auth / security (ADR 022/024) — top priority**
...
**Accessibility (ADR 015, WCAG 2.2 AA) — top priority**
...
- The only allowed comment is an English block comment directly above a complex or non-obvious declaration explaining
  intent/constraints (ADR refs, security invariants, quirks).
