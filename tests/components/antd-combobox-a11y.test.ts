...
// ADR 015 — regression guard for patches/ant-design-vue@4.2.6.patch.
//
...
describe('ant-design-vue combobox accessibility (patched)', () => {
	it('names the closed combobox without dangling ARIA references', async () => {
		...
		// The crux of aria-required-attr: present and concrete, not omitted.
		expect(input.getAttribute('aria-expanded')).toBe('false')
		// The crux of aria-valid-attr-value: no reference to an unrendered listbox.
