...
import { MAX_PAGE_SIZE, PROJECT_OPTION_DEPENDENCIES } from '@shared/utils/api-types'
import { describe, expect, it } from 'vitest'

/**
 * Mirror of the backend's ProjectOptionEnum dependency graph. The
...
describe('MAX_PAGE_SIZE', () => {
	it('matches the ceiling every v2 list controller enforces', () => {
