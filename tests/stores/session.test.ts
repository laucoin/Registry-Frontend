...
describe('session store', () => {
	...
	describe('canAccessProjectDomain', () => {
		...
		/**
		 * The exact conjunction the backend's @PreAuthorize enforces: an option
		 * domain needs its option gate AND its read authority, both namespaced to
		 * the project being asked about.
		 */
		it.each([
