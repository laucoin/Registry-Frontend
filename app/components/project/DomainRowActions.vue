...
const props = defineProps<{
	...
	canUpdate: boolean
	canDelete: boolean
	// Opt-in: only pages that wire an @edit handler show the Edit item.
	editable?: boolean
	// Domain prefix for the E2E hooks (e.g. "movement" → movement-row-actions,
	// movement-action-disable/-enable/-delete).
	testid?: string
}>()
