...
@Injectable()
export class MovementState extends GenericEventElementState<MovementStateModel> implements NgxsOnInit {
    ...
    @Selector()
    public static movementTypesMetadata (state: MovementStateModel): SelectItem<string | undefined>[] {
