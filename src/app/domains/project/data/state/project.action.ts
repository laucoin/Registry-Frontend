...
export class StartProjectsPageLoader {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.START_PROJECTS_PAGE_LOADER
}

export class StopProjectsPageLoader {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.STOP_PROJECTS_PAGE_LOADER
}

export class FetchProjectsPage {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.FETCH_PROJECTS_PAGE
...
export class UpdateProjectsPageSearchParams {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.UPDATE_PROJECTS_PAGE_SEARCH_PARAMS

    public constructor (public readonly params: ProjectPageParamsModel) {}
}

export class StartProjectLoader {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.START_PROJECT_LOADER
}

export class StopProjectLoader {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.STOP_PROJECT_LOADER
}

export class FetchProject {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.FETCH_PROJECT

    public constructor (public readonly id: string) {}
}

export class ResetProject {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.RESET_PROJECT
}

export class CreateProject {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.CREATE_PROJECT

    public constructor (public readonly project: ProjectDto) {}
}

export class UpdateProject {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.UPDATE_PROJECT

    public constructor (public readonly id: string, public readonly project: ProjectDto) {}
}

export class DisableProject {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.DISABLE_PROJECT

    public constructor (public readonly id: string) {}
}

export class EnableProject {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.ENABLE_PROJECT

    public constructor (public readonly id: string) {}
}

export class DeleteProject {
    public static readonly type: ProjectActionEnum = ProjectActionEnum.DELETE_PROJECT
